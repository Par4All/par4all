%%
%% $RCSfile: newgen_manual.tex,v $ (version $Revision$)
%% $Date: 1996/11/22 22:06:02 $, 
%%
%% -*- Mode: TeX -*-
%%
...
\author{{\em Pierre Jouvelot}\\
        ...
        35, rue Saint-Honoré,\\
        F-77305 Fontainebleau \textsc{cedex}}

\date{December 1990 \\ last modified: $Date: 1996/11/22 22:06:02 $
}
...
Newgen value with filtering top-down decisions and rewriting bottom-up
actions at several domains. 
...
\begin{verbatim}
void
gen_multi_recurse(<Newgen Object> obj,
 [int d, bool (*flt)(<Newgen Object>), void (*rwt)(<Newgen Object>)]*,
            NULL);
\end{verbatim}
}
