...
\begin{verbatim}
p4a --cuda optimized_example.c -o cuda_optimized_example
\end{verbatim}
...
\begin{verbatim}
p4a --accel --openmp example.c -o openmp_example
\end{verbatim}
which produces a \texttt{openmp\_example} binary executable file with its
