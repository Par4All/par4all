...
\url{http://download.par4all.org/doc/simple_tools/p4a/par4all_user_guide.pdf}
...
To generate \Aopenmp code from a C or Fortran program, use \texttt{p4a} with option 
 \texttt{--openmp}, for example for a Fortran program:
\begin{verbatim}
