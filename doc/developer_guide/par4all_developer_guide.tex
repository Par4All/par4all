...
\begin{verbatim}
p4a_git --branch-action-name p4a git push origin \$branch >& /dev/null
\end{verbatim}
The \verb|>& /dev/null| is to avoid spamming the screen with MB of commit
messages. But you can remove it if you want.
