...
repositories. For security, these gateways exist only on the laptop
...
more global name \texttt{pips-gfc+gcc}. This provides versions for the merge
...
\item \verb|p4a_doc| in \verb|src/dev| is used to compile the \Apfa
  documentation and publish it on the server. See
  \texttt{p4a\_doc -h} for the instructions.
\end{itemize}
...
\Apfa development to perform this
sequence of steps in order to avoid the loss
of information.
...
In this appendix, options and other ancillary scripts are desribed.
