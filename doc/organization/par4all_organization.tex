...
\item[\texttt{--dir}:] Validate tests which are done in packages/PIPS/validation/directory\_name. Syntax is ./p4a\_validate\_class.py --dir dir1 dir2 dir3..

\item[\texttt{--test}:] Validate tests which are done in argument. Syntax is ./p4a\_validate\_class.py --test directory\_test/test.f for example
