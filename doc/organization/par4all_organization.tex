...
\marginpar{TODO and to correct}

Before using \Apips, once it is installed, you should do, according to your
shell, a
\begin{verbatim}
source .../etc/par4all-rc.sh
\end{verbatim}
or a
\begin{verbatim}
source .../etc/par4all-rc.csh
\end{verbatim}
...
some packages, please work in the upstream package and not in \Apfa. Since
it is easy to compile \Apfa with some package stuff outside of \Apfa (see
