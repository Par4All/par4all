...
If you are short in the default temporary directory to build up a new
distribution (as our old machine used to build the 32-bit Debian
distribution), you can change the \texttt{MPDIR}, \texttt{TEMP} or
\texttt{TMP} to a directory location when there is enough room (1+ GB).
