...
\author{Ronan \textsc{Keryell}, Grégoire \textsc{Péan}, Claire
  \textsc{Seguin}, Mickaël \textsc{Thievent}\\
  ---\\
  HPC Project}
...
\texttt{make validate}.\marginpar{ Right now it is still in the
...
\item[\texttt{pips-gfc+gcc}] point to a working \Apipsgfc implementation
  of the Fortran 95 extension for \Apips in \texttt{package/pips-gfc};
\item[\texttt{pips-gfc-4.4.1}] point the original developments of Raphaël
  in \Agcc in \texttt{package/pips-gfc};
