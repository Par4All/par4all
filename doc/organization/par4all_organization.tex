...
\begin{alltt}
  ...
  src/simple_tools/p4a_setup [--prefix=/install/dir] [-v[v[v]]] --jobs=8 [...]
\end{alltt}%$
...
sub-packages, in this case see section~\ref{sec:packages}): to make sure
you do not break the compilation process, you should compile your work
before committing it on the central repositories. By a nice side effect,
it allows you to test your code. \smiley
