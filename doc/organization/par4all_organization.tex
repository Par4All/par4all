...
\verb|$P4A_ROOT/run| by default. If you want to change the install
location, you can export the \verb|INSTALL_PREFIX| variable to the
installation directory you want (have a look to
\S~\ref{sec:making-distributions} for example).
...
compile and run:
\begin{quote}
  \texttt{cproto}, \texttt{flex}, \texttt{bison},
  \texttt{texlive-latex-extra}, \texttt{tex4ht}, \texttt{automake},
  \texttt{libtool}, \texttt{libreadline5-dev}, \texttt{python2.6-dev},
  \texttt{swig}, \texttt{python-ply}, \texttt{libgmp3-dev},
  \texttt{libmpfr-dev}, \texttt{gfortran}
\end{quote}
