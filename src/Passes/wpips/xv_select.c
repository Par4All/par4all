/* 	%A% ($Date: 1996/09/11 21:33:19 $, ) version $Revision$, got on %D%, %T% [%P%].\n Copyright (c) École des Mines de Paris Proprietary.	 */

#ifndef lint
char vcid_xv_select[] = "%A% ($Date: 1996/09/11 21:33:19 $, ) version $Revision$, got on %D%, %T% [%P%].\n Copyright (c) École des Mines de Paris Proprietary.";
#endif /* lint */
...
create_select_menu()
{
   ...
   /* Exchange of the order of start_directory_notify &
      ...
      :-) RK, 19/02/1993. */
   directory_menu_item = xv_create(NULL, MENUITEM,
                                   MENU_ACTION_ITEM,
                                   "Directory",
