...
\end{verbatim}
  ...
  \item Run the command {\tt make all} to now derive from {\tt
    ...
    {\tt builder-map.h} and to copy them into {\tt \$PIPS\_INCLUDEDIR}
    (i.e. {\tt \$PIPS\_ROOT/Include}); to also derive {\tt pipsmake.rc},
    {\tt properties.rc} and {\tt wpips.rc}, and to copy them into {\tt
      \$PIPS\_LIBDIR}.
    
  \end{itemize}
  
\item In the directory {\tt \$PIPS\_BINSRCDIR} (i.e. {\tt
    \$PIPS\_ROOT/Src/Passes}):
