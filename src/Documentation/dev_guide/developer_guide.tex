...
\item Obtain an svn user account on \texttt{svn.cri.ensmp.fr}
  ...
  do in the branch is your own affair, and no message is sent to the
  world on commits. For interns, the default policy is to send a
  message to the intern and the developer responsible for his/her
  work.
...
to push back your changes once you get to civilized surroundings.

Why not switch all this stuff to \texttt{git}, which is so
\emph{cool}? There are several answers:
\begin{description}
