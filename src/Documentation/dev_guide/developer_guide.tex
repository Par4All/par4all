...
\item[Validate]: \index{Validate} Non-regression tests; see ?!?;
  ...
  for a \texttt{.test} file, performs some substitutions and executes the
  test file. Finally if none of these case apply, the scripts parallelize
  all modules.
