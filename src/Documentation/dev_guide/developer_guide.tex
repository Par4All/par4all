...
\item Create your own development branch for pips.
{\small
\begin{verbatim}
sh> cd pips_dev
...
\item To merge into your branch on-going developments from trunk:
{\small
\begin{verbatim}
...
sh> svn mergeinfo \
  http://svn.cri.ensmp.fr/svn/pips/calvin/my-branch-name \
  --show-revs eligible
