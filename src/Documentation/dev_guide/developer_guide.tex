...
\emph{repository, checkout, commit} are necessary to develop
in pips. 
...
It is also possible to use the \texttt{svn\_branch.sh} script
directly to create a branch for any part of pips, including the
full software.

It is also possible to use \texttt{svn} directly to create and
