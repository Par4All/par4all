...
A crude script \verb|setup_pips.sh| on the web site and in
...
\begin{verbatim}
sh> setup_pips.sh /tmp/MYPIPS calvin
...
sh> source /tmp/MYPIPS/pipsrc.sh
sh> # enjoy
\end{verbatim}
...
\begin{verbatim}
sh> cd /tmp/MYPIPS/prod/pips/src/Libs/hpfc
...
{\em tag\/} indexing mechanism under editors such as {\bf\tt emacs} or
{\bf\tt vi}. 
...
directly in your \verb|~/.emacs| with something like:
\begin{verbatim}
(setq tags-table-list '("." "~/projets/PIPS/MYPIPS/prod/pips" "/usr/src/linux-2.6.16"))
\end{verbatim}
...
\end{verbatim}
  ...
  \item Run the command {\tt make install}
