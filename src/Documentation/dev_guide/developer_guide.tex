...
delete of the current workspace\footnote{}, and a quit.
...
\begin{verbatim}
  sh> cd validation
  sh> make -j 8 parallel-validate
  sh> make -j 8 TARGET='HardwareAccelerator Hpfc' parallel-validate
\end{verbatim}
...
\item[missing] there is no result (\texttt{test} file) in a result
  directory. \textbf{This is bad!}
\end{description}
