% PIPS Project
%
% $RCSfile: properties-rc.tex,v $ ($Date: 1996/03/27 17:40:25 $, )
% version $Revision$
% got on %D%, %T%
% $Id$
%
...
It also is possible to keep only dtrue ataflow (Def -- Use) dependences in
...
iterations. The following option, when set to false, remove this
constraint. It is useful for single assignment programs, to discover what
section is really local to each iteration.
