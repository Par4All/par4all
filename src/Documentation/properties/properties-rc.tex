...
\subsubsection{Generate load store statement}

Duting the simdization process, one may want to generate automagically the appropriate load / store instructions.
This is generally the case when you simdize classical instruction ( add, divide \dots) but you may want to disable this if you simdize unusal instruction (what if you simdize the load and store ? hu ?)

\begin{verbatim}
SIMD_GENERATE_LOAD_STORE TRUE
\end{verbatim}
