...
named \texttt{eole}. The version and options set can be controled from
...
Partial evaluation includes constant propagation and partial evaluation of
logical expressions. Two properties control what is to be done.

\begin{verbatim}
PARTIAL_EVAL_LOGICAL_EXPRESSIONS FALSE
PARTIAL_EVAL_PROPAGATE_INTEGER_CONSTANTS TRUE
\end{verbatim}
...
array bounds checking options for the instrumentation of the code.

\begin{verbatim}
NORMAL_ARRAY_BOUND_CHECK TRUE
INSTRUMENTATION_ARRAY_BOUND_CHECK FALSE
NORMAL_REGION_BASED_ARRAY_BOUND_CHECK TRUE
INSTRUMENTATION_REGION_BASED_ARRAY_BOUND_CHECK FALSE
...
{\em Analyse statique et dynamique de la compléxité  des programmes
scientifiques}, 
Thèse de doctorat de l'université Pierre et Marie Curie, 14
