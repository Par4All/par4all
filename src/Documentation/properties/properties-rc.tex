...
The following property tells the array bound checking phase to instrument
codes with the STOP or the PRINT message. Logically, if a bound violation
...
purposes, one may need to display all possible out-of-bound errors but not
to stop the program. In this case, a PRINT message is chosen. By default,
we use the STOP message.
 
\begin{verbatim}
ARRAY_BOUND_CHECKING_FOR_DEBUGGING FALSE
\end{verbatim}
