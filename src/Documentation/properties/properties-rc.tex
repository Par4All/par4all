% PIPS Project
%
% $RCSfile: properties-rc.tex,v $ ($Date: 1995/11/15 10:41:52 $, )
% version $Revision$
% got on %D%, %T%
% $Id$
%
...
directly spent in each phase as well as the times spent reading/wirting data
...
\verb+pipsmake+ request is not implemented.
