...
Compute regions using the algorithm described in report E/181/CRI,
called {\em $T^{-1}$ algorithm}. It provides more accurate regions, and
preserve MUST approximations more often. But it is less efficient. Its
default value is TRUE for the moment, but it will be later changed to
FALSE.
...
\begin{verbatim}
HPFC_EXPAND_COMPUTE_COMPUTE TRUE
\end{verbatim}
