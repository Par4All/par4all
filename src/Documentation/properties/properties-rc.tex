% PIPS Project
%
% $RCSfile: properties-rc.tex,v $ ($Date: 1997/01/14 08:59:38 $, )
% version $Revision$
% got on %D%, %T%
% $Id$
%
...
By setting this property \verb|unspaghettify| is applyed
directly in the controlizer phase.

\begin{verbatim}
UNSPAGHETTIFY_IN_CONTROLIZER   FALSE
\end{verbatim}
...
\subsection{Control Flow Graph Restruturing}

The following option enables the use of IF/THEN/ELSE:
\begin{verbatim}
