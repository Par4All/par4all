% PIPS Project
%
% $RCSfile: properties-rc.tex,v $ ($Date: 1995/09/27 14:06:16 $, )
% version $Revision$
% got on %D%, %T%
% $Id$
%
...
\subsection{WPips graphical interface}

Wpips catch the XView error. For debug, it may be interesting to trap
just when the error occurs instead of just display a warning :
\begin{verbatim}
ABORT_ON_WPIPS_XVIEW_ERROR FALSE
\end{verbatim}
...
Whether to use the local buffer management.

\begin{verbatim}
HPFC_BUFFER_SIZE 3920
