% PIPS Project
%
% $RCSfile: properties-rc.tex,v $ ($Date: 1997/02/10 12:45:49 $, )
% version $Revision$
% got on %D%, %T%
% $Id$
%
...
property ({\tt REGIONS_OP_STATISTICS}) is set to ({\tt TRUE}) statistics are
...
\begin{verbatim}
CLEAN_UP_SEQUENCES_DISPLAY_STATISTICS TRUE
\end{verbatim}
