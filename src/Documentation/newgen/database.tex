...
le nom de la base suffisé par \textsc{database}.
...
\texttt{pipsdbm}.  Elle devrait être nommée \texttt{database-util} si une
...
programme, ce sont les entités (et les \texttt{user\_file}, mais ils sont
