...
\domain{attachee = persistent reference + persistent loop + persistent module_head:entity + {complementary_sections, complexities, continuation_conditions, cumulated_effects, out_regions, preconditions, privatized_regions, proper_effects, proper_regions, regions, static_control, transformers, decoration}}
