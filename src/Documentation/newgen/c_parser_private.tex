...
\domain{c\_parser\_context = current\_scope:string x current\_type:type x current\_storage:storage x current\_qualifiers:list x is\_typedef:bool x is\_static:bool}
