...
\domain{reduction_operator = \{ none , min , max , sum , prod , and , or \}}
...
\domain{reduction = reference x op:reduction_operator x dependences:entity*}
...
\domain{statement_reductions = statement -> reductions}

Function from entity to reductions to be used to store callees'
reductions. 

\domain{entity_reductions = entity -> reductions}
