...
\domain{pragma = string}
{}

Pragmas fields are used to attach \verb|#pragma| to statements.

Right now for testing a pragma is only a \texttt{string} but at
middle-term it should be a list of expressions. In this way classical
transformations may work by side effect on pragmas too (such as variable
