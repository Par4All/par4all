...
\domain{Parameter = type x mode x name:string}

Objects of type \texttt{parameter} represents type and inout
information for formal parameters. The name field is used to store a
dummy parameter name in C function declarations, which may be
different from the formal parameter name. By default, this name is the
empty string, "".
