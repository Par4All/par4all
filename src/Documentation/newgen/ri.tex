...
\domain{Constant = int + litteral:unit + call:entity}
{}
...
because its value is carried by its name. A floating point variable
statically initialized with 123.45 as an initial value of type
\verb/constant/ and of kind \verb/call/, since 123.45 is a nullary
function.
