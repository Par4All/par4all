...
\verb/va_arg(t,e)/ where \verb/t/ is a type and \verb/e/ is an
expression. The domain \verb/sizeofexpression/ is reused, in spite of
its name, because it combines types and expressions. The number of
arguments is left unspecified as well their respective kinds.
