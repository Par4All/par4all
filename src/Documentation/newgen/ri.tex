...
\domain{Persistent_Statement_To_Statement = persistant statement -> persistent statement}
{
...
\domain{Persistent_Control_To_Statement = persistant statement -> persistent control}
{
