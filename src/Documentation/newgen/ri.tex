...
located in \verb+$PIPS_ROOT/Src/Documentation/newgen/ri.tex+\footnote{The
  development version is located in \verb+$PIPS_DIR/Development/Documentation/newgen/ri.tex+.} (\verb+ri+
...
\domain{persistant\_statement\_to\_statement = persistant statement -> int}
{}
...
sequence, must effects\footnote{Needless to say, reality is much more
  ...
  intuition about may and must information.}.
...
as well as pseudo-variables, known as \ver/PHI/ variables. There is one
