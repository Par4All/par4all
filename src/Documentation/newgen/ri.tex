...
\domain{persistant\_statement\_to\_schedule = persistant statement -> schedule:int}
{}

Type \texttt{persistant\_statement\_to\_schedule} is used in bdsc
communication generation to store the cluster where a statement is
