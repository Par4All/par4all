...
A set of such variables, \verb/callers/\footnote{Obviously, \verb/callers/ are
of type \verb/callees/...}, \verb/callees/, \verb/all/, is
used by Pipsmake to schedule interprocedural
...
functionally equivalent, but strings are often more of a pain to handle.
...
Field /verb/locals/\index{Private} is used to declare variables whose life time is
limited to the loop body. They can be privatized and their effects can
