...
\index{Basic}\index{Integer}\index{Real}\index{Complex}\index{Character}
...
regions}. They were defined by R\'emi Triolet in~\cite{Trio84} and
extended by B\'eatrice Creusillet in~\cite{Creu96}.
...
\verb/gen_recurse()/ and \verb/gen_multi-recurse()/. These two iterators
...
{\em Analyses de r\'egions de tableaux et applications}, Th\`ese de
Docteurat, \'Ecole des mines de Paris, D\'ecembre 1996
