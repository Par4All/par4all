...
\HPFC{} is the HPF prototype compiler included in the \PIPS project.  It has
been developped by \FC{}. In order to compile an HPF program which uses
...
the supplied fake functions. However, here are some explanations.
