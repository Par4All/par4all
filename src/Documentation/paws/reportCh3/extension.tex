...
Script \emph{add\_tool} is placed in \emph{paws\_app$\backslash$utils} directory. It is a bash script. See Listing \ref{AddToolUsage} for an invocation example. 
