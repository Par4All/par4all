...
%%
%% $Log: faq.tex,v $
%% Revision 1.8  1999/01/11 09:13:44  irigoin
%% Because of EDF, section of code clean up added.
%%
%% Revision 1.7  1999/01/09 18:20:10  irigoin
%% Two sections added about loop parallelization, following new results from
%% the Perfect Club and the Spec CFP95 benchmarks.
%%
%% Revision 1.6  1998/10/21 08:20:12  irigoin
%% Some information added about the input language
%%
%% Revision 1.5  1998/10/20 20:31:01  irigoin
%% Section about automatic code optimization added after Martin Griebl's visit
%%
...
Formal functional are still unsupported ($Date: 1999/01/11 09:13:44 $) and
...
regions (\verb/rice_regions_dependence_graph/) should be
selected. Furthermore, regions depend on transformers which, like
preconditions, may be computed in different ways. The most accurate
information is gathered with the two selections
\verb/transformers_inter_full/
and \verb/preconditions_inter_full/.
