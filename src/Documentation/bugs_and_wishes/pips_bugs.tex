...
\begin{enumerate}
  ...
  \item run PIPS on SPEC77 (PerfectClub); look at del4, gloop and gwater;
	these files are now properly parsed; parallelization bug from
	Yi-qing prevents interprocedural parallelization in del4; effects
	bug in gfidi prevents interprocedural parallelization in gloop;
	effects bug in lrgscl prevents interprocedural parallelization in
	gwater;
