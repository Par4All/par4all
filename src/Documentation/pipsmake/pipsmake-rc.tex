...
To be efficient, phase \texttt{SPAGUETTIFY}\ref{paragraph-spaghettify}
...
Phase \texttt{FULL\_FSM\_GENERATION}\ref{paragraph-full-fsm-generation}
must be applied first !
