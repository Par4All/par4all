...
Index Set Splitting  splits the loop referenced by
...
Additionnaly, \lstinline|INDEX_SET_SPLITTING_SPLIT_BEFORE_BOUND| can be used to accurately tell to peel the loop before or after the bound given in \lstinline|INDEX_SET_SPLITTING_BOUND|
\begin{PipsProp}
