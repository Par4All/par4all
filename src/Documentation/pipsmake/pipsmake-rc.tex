...
A comma seperated list of commutative simd operators:
\begin{PipsProp}{SIMDIZER_COMMUTATIVE_OPERATORS}
SIMDIZER_COMMUTATIVE_OPERATORS ""
\end{PipsProp}
...
since in C you can represent the blocks.  Right now, the prettyprint of
the C block is done in the wrong way, so if you use this option, you will
have redundant blocks inside instructions, but you will have all the other
hidden blocks too...
