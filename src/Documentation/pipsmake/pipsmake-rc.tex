...
Use \PipsPropRef{LINEARIZE_ARRAY_VLA_ONLY} to limit this pass to C99 VLA array.
\begin{PipsProp}{LINEARIZE_ARRAY_VLA_ONLY}
LINEARIZE_ARRAY_VLA_ONLY FALSE
\end{PipsProp}
...
Use following property to control wheter inlining should ignore stubs:
...
\begin{PipsPass}{quick_scalarization}
  ...
  criteria. Pass \PipsPassRef{quick_scalarization} solely relies on
  proper and cumulated effets, and as such may fail to scalarize some
  accesses. However, it is expected to give good results in current
  cases, especially after loop_fusion.
