...
\verb/p!=NULL/. Temporarily, to perform an interprocedural analysis,
it must be turned to {\tt FALSE}.
...
Whether to merge OpenCL kernel-based operations.
\begin{PipsProp}{HWAC_OPENCL_MERGE_KERNEL_OPERATIONS}
HWAC_OPENCL_MERGE_KERNEL_OPERATIONS FALSE
\end{PipsProp}

Whether to generate OpenCL specialized kernel-based operations.
\begin{PipsProp}{HWAC_OPENCL_GENERATE_SPECIAL_KERNEL_OPS}
HWAC_OPENCL_GENERATE_SPECIAL_KERNEL_OPS FALSE
\end{PipsProp}
