...
but it should become the default option because it is always more
accurate, at least indirectly because the systems are smaller. The
number of overflows is reduced, as well as the execution time. See for
instance the test case Semantics/sync04. This
