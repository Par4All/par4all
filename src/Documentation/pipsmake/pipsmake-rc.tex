...
The property \PipsPropRef{POINTS_TO_NULL_POINTER_INITIALIZATION} allows the initialization of formal parameters and
global variables to null location. The safe value is  {\tt TRUE}, it prevents from dereferencing a null pointer. When perfermorming
interprocedural analysis it should be turned to {\tt FALSE}.
