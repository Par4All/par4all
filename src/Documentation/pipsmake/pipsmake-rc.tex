...
limit\_nested\_parallelism in order to maximize the number of parallel
...
desired level of nested parallelism.
...
STATEMENT_INSERTION_PRAGMA "pips inserted statement"
\end{PipsProp}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Loop expansion
