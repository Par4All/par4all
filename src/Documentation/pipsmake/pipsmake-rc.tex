...
are no longer working and have been replaced by {\tt gpips}.
...
code and ASCII files. The useful information is located in the {\em
  PipsMake} areas, a very simple literate programming environment... For
instance \verb+alias+ information is used to generate automatically menus
for window-based interfaces such as \verb+wpips+ or \verb+gpips+. Object (a.k.a resource) types and functions are renamed
...
extracted to generate on-line information for {\tt wpips} and
automatic completion for {\tt tpips}.
...
{\tt TPIPS} is one of PIPS user interfaces.
