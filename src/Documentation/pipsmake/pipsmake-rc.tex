...
\paragraph{Constant type inference}

This property is used by the sac library to know if it must override C constant type inference.
...
\paragraph{Extravagant SIMD atomizer}
