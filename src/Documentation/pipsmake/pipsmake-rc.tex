...
\verb+KERNEL_LOAD_STORE_LOAD_FUNCTION+ and \verb+KERNEL_LOAD_STORE_STORE_FUNCTION+ can be used to customized the load / store function.
\begin{PipsProp}
KERNEL_LOAD_STORE_LOAD_FUNCTION "memload"
KERNEL_LOAD_STORE_STORE_FUNCTION "memstore"
\end{PipsProp}
