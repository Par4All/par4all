...
Split a parallel loop with local index into three parts : a host side part, a kernelk part and an intermediate part.
...
perform various checks on a terapix microcode to make sure it can be synthesized.
%%!UserManualDocumentation
\begin{PipsMake}
...
Whether to remove duplicate operations in the DAG.
...
If set, property \verb+OUTLINE_ALLOW_GLOBALS+ is used not to pass globals as parameters.
\begin{PipsProp}
OUTLINE_MODULE_NAME ""
OUTLINE_LABEL ""
