...
This very simple transformation is a subset of the flatten_code
transformation. It recurses through all variable declarations, and
splits them in two if they specify an initial value.
