...
of go to statements regenerated.
\end{PipsPass}
...
Fortran parallel DO loops. \PipsPropRef{MASK_EFFECTS_ON_PRIVATE_VARIABLES}
can be set to FALSE to prevent this behavior.
\begin{PipsProp}{MASK_EFFECTS_ON_PRIVATE_VARIABLES}
MASK_EFFECTS_ON_PRIVATE_VARIABLES TRUE
\end{PipsProp}
...
\begin{PipsMake}
coarse_grain_parallelization_with_reduction > MODULE.code
        < PROGRAM.entities
        < MODULE.code
        < MODULE.cumulated_effects
        < MODULE.cumulated_reductions
...
Whether to unroll while loops for SPoC accelerator:
\begin{PipsProp}{HWAC_FREIA_SPOC_UNROLL_WHILE}
HWAC_FREIA_SPOC_UNROLL_WHILE FALSE
\end{PipsProp}
