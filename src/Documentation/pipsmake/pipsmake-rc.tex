...
Slicing and specialization slicing have been introduced in~\cite{AHJR2014} and are more general than cloning. For the time being, no slicing transformation is available in \PIPS since they usually do not preserve the program semantics.
\end{PipsPass}
