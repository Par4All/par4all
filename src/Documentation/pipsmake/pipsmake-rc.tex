...
when it is useless according to the OUT region\marginpar{Serge: motivation?}.
...
This pass may be useful to make C source code more palatable to C to
VHDL converter\marginpar{Serge: more motivations?}. It is also useful
to propagate constants contained in an array since the semantics
passes only analyze scalar variables. 
