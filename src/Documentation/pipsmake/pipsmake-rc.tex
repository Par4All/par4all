...
This transformation replaces all arrays in the module by equivalent linearized arrays.
...
Use \PipsPropRef{LINEARIZE_ARRAY_USE_POINTERS} to control wether arrays are declared as 1D arrays or pointers. Pointers are accessed using dereferencement and arrays using subscripts.
