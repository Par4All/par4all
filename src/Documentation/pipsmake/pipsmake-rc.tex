...
for regions (see section~\ref{subsection-array-regions}).
...
and/or RW regions. Since this is still at experimentation level, it's
...
results. This property also affects the computation of regions.
...
compute points-to relations, based on Emami algorithm. Emami algorithm
...
is\PipsPassRef{Intraprocedural Summary Points To Analysis}.  
\begin{PipsMake}
...
This phase will handle computing points-to relations for formal
parameters. It will create fictious sinks for formal parameters and
provide a set of points-to to the \PipsPassRef{points_to_analysis}. 
\begin{PipsMake}
