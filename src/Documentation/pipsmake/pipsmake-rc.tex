...
Also, 1lAs explained above, Property
...
C. The current default value is FALSE because it is better for
automatic loop parallelization, but this could be changed as a
privatization pass should do as well while preserving perfect loop nests.
