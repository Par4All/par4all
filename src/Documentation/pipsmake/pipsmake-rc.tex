...
\end{PipsProp}
specifies how user errors are handled after printing the error message
on \verb/stderr/: return and go ahead, usually when \Pips{} is used
interactively, or core dump for debugging purposes and for script
executions, especially non-regression tests.

Property
\begin{PipsProp}{ACTIVE_PHASES} 
ACTIVE_PHASES "PRINT_PARSED_CODE PRINT_CODE PRINT_PARALEL_CODE PRINT_CALLGRAPH PRINT_ICFG TRANSFORMERS_INTRA_FAST INTRAPROCEDURAL_SUMMARY_PRECONDITION PRECONDITIONS_INTRA ATOMIC_CHAINS RICE_FAST_DEPENDENCE_GRAPH MAY_REGIONS"
\end{PipsProp}
...
Resources that create ambiguities for \Pipsmake{} are:
\begin{itemize}
