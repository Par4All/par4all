...
\textttvalidation/AcceleratorUtils/include/par4all.c} The following.

The properties that can be used to customized the allocate/load/store functions:
...
Due to the current limitation of the effects, PIPS provides this property
to force the load of any array that is written in the kernel. This
actually fixes the problem of partially written array. A better solution
using the region is under implementation.
