...
using the property KERNEL\_LOAD\_STORE\_VAR\_PREFIX.
...
the propetty CROUGH\_ALL\_SCALAR\_BY\_VALUE
...
\begin{PipsProp}{CROUGH_ALL_SCALAR_BY_VALUE}
CROUGH_ALL_SCALAR_BY_VALUE FALSE
\end{PipsProp}
