...
\begin{PipsPass}{loop_nest_unswitching}
  ...
  \PipsPassRef{suppress_dead_code} works afterward
\end{PipsPass}
...
\end{PipsProp}
\begin{PipsProp}{SYMBOLIC_TILING_PERFECT_TILES}
SYMBOLIC_TILING_PERFECT_TILES FALSE
\end{PipsProp}
...
$18.10$ of~\cite{Muc97}). So \PipsPassRef{suppress_dead_code} in PIPS is in
...
\PipsPropRef{CLEAN_DECLARATIONS} is automatically done at the end, this is why 
...
\PipsPropRef{TRUST_ARRAY_DECLARATIONS} and/or
\PipsPropRef{TRUST_ARRAY_REFERENCES} to make sure that as many loops
...
% ASU86
\bibitem{ASU86} Aho, Sethi, Ullman,
...
% CCK86
  \bibitem{CCK86} C. D. Callahan, K. D. Cooper, K. Kennedy and L. Torczon,
...
% CH78
  \bibitem{CH78} N. Halbwachs and P. Cousot, Automatic Discovery of Linear
...
%
% FI: all the references below have been checked for the introduction
% of pips.bib derived from the renpar-polyedres.bib
%

% IT88
  \bibitem{IT88} F. Irigoin, R. Triolet,
...
%} 
\bibitem{JG89} P. Jouvelot, D. Gifford, {\em Reasoning about
...
% Kar76
\bibitem{Kar76} M. Karr, Affine Relationships among Variables of a Program,
...
%}
% LY88c
\bibitem{LY88c} Zhiyuan Li, Pen-Chung Yew, {\em Program parallelization
    with interprocedural analysis}, The Journal of Supercomputing,
  Vol. 2, N. 2, pp. 225-244, Springer, 1988.

% Muc97
\bibitem{Muc97} Steven S. Muchnick,
  {\it Advanced Compiler Design Implementation}
  Morgan Kaufmann Publishers, 1997

% Ngu02
\bibitem{Ngu02} Thi Viet Nga Nguyen, {\em Efficient and
...
% Pol88
\bibitem{Pol88} A.~A.~Pollicini, Using Toolpack Software Tools, in {\em
...
% GFL00
  \bibitem{GFL00} Martin Griebl, Paul Feautrier and Christian Lengauer
