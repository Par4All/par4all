...
Generate code from a FREIA application targetting a particular
...
This transformation is quickly developped to fullfill the need of a
...
proves to be usefull during simdization to recognize some idioms. Note
...
This will ony activate common subexpressions elimination.
...
This transformation has been developped in PIPS for heterogeneous computing
...
Inlining(s), which must be performed explictly by the user with tpips
...
The code externalization and adpatation for a given hardware
...
Fabein Coelhp and Francois Irigoin.
