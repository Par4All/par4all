...
\lstinline|for(int i = a;...;...)| are represented in the RI as
\begin{lstlisting}
{
  int i;
  for(i = a;...;...)
...
\end{lstlisting}
by using a declaration splitting. Since it is not fully implemented
(initializer with complex structure fields...) a naive but robust version
is provided to generate a code like this:
...
\end{lstlisting}
This is generated according to the following property
\PipsPropRef{C_PARSER_GENERATE_NAIVE_C99_FOR_LOOP_DECLARATION}
...
\subsection{Filtered Proper Memroy Effects}
...
This transformation replaces all arrays in the module by equivalent linearized
arrays. This only works with array starting their indices at 1.
\end{PipsPass}
...
\marginpar{RK: François, Mehdi, is it still true?}
