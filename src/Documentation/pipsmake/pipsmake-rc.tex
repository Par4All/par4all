...
%% Revision 1.39  2005/08/24 13:14:42  coelho
%% pas de caracteres bizarres.
%%
%% Revision 1.38  2005/08/24 13:04:13  coelho
%% tests...
%%
%% Revision 1.37  2005/08/08 13:13:23  irigoin
%% Preconditions are now required for refine_transformers as they turn out to
%% be useful intraprocedurally.
%%
%% Revision 1.36  2004/03/26 09:01:48  hurbain
%% Oops. Debug removal.
%%
%% Revision 1.35  2004/03/26 08:34:16  hurbain
%% Removed claire rough
%%
%% Revision 1.34  2004/03/25 16:17:58  hurbain
%% Modified claire_printed_file
%%
%% Revision 1.33  2004/03/11 13:55:17  irigoin
%% Phase/rule print_claire_code added, resource claire_printed_file added.
%%
%% Revision 1.32  2004/02/25 13:44:59  guerin
%% Update pipsmake-rc definition for PHRASE_DISTRIBUTOR_CONTROL_CODE
%%
%% Revision 1.31  2004/02/24 14:51:17  guerin
%% New pipsmake-rc definition for PHRASE_DISTRIBUTOR_CONTROL_CODE
%%
%% Revision 1.30  2004/02/19 16:14:00  guerin
%% New pipsmake-rc definition for PHRASE_DISTRIBUTOR
%%
%% Revision 1.29  2004/01/29 15:20:23  guerin
%% New pipsmake-rc definition for FULL_FSM_GENERATION
%%
%% Revision 1.28  2004/01/15 14:02:13  guerin
%% Adding FULL_SPAGHETTIFY phase for PHRASE project
%%
%% Revision 1.27  2004/01/12 16:26:38  guerin
%% Adding new phases for PHRASE project
%%
%% Revision 1.26  2003/12/19 10:30:43  guerin
%% Fixing bad name for smalltalk code resource name in PRINT_CODE_SMALLTALK phase
%%
%% Revision 1.25  2003/12/17 17:41:30  guerin
%% Fixing better locations for PHRASE passes
%%
%% Revision 1.24  2003/12/17 16:26:11  guerin
%% Adding fundations for PHRASE project
%%
%% Revision 1.23  2003/10/09 07:22:54  nguyen
%% Remove c_parser_tmp and add more comments
%%
%% Revision 1.22  2003/08/12 15:49:45  irigoin
%% compilation unit concept added
%%
%% Revision 1.21  2003/07/30 15:38:02  irigoin
%% Temporary debug version for c_parser
%%
%% Revision 1.20  2003/07/30 14:41:24  irigoin
%% Phase/rule c_initializer added. Resource c_source_code added.
%%
%% Revision 1.19  2003/07/30 14:19:02  ferrand
%% Fix bad definition in SINGLE_ASSIGNMENT declaration
%%
%% Revision 1.18  2003/07/30 14:14:13  ferrand
%% Add single_assignment and simd_remove_reductions phases for SAC.
%%
%% Revision 1.17  2003/07/22 15:37:20  irigoin
%% Double occurence of section about program_precondition
%%
%% Revision 1.16  2003/07/22 15:32:14  irigoin
%% Reordering of sections about module_initial_precondition and inter- and
%% intra-procedural summary preconditions. Pipsmake requires resources to be
%% producable by at least one rule before they can be used by another one.
%%
%% Revision 1.15  2003/07/12 16:58:02  irigoin
%% Resource MODULE.initial_precondition added as input to rule intraprocedural_summary_precondition
%%
%% Revision 1.14  2003/07/11 15:59:57  irigoin
%% New rules to compute summary preconditions, explicitly intra- or
%% inter-procedurally. Might not be the smartest way to perform the selection
%% between intra- and inter-procedural analyses. The rules
%% preconditions_intra and preconditions_inter could be fused since the
%% intra/inter-procedural aspect is moved into the selection of the rule for
%% the computation of summary_precondition.
%%
%% Revision 1.13  2003/06/30 10:03:48  nguyen
%% Create C_PRINTED_FILE resource for C prettyprinter
%%
...
%% Added simdizer for FranÅÅÅÁois Ferrand.
%%
...
\paragraph{Declaration of the C parsers:}

The compilation unit does not contain any function definitions after the
workspace creation. The compilation units must be parsed before the
function definitions can be parsed.
...
containing C keywords and typedef names in each compilation unit.  
...
algorithms use a fix-point on vector subspace (i.e. ÅÅÅ‡ la K{\sc
...
\subsubsection{PHRASE: high-level language transformation for partial evaluation in reconfigurable logic}
...
\paragraph{Phrase Distributor Initialisation}
...
\paragraph{Phrase Distributor Control Code}
...
\end{center}
which control the fact that the same global variable (global to the
...
\texttt{FULL\_SPAGHETTIFY}\ref{paragraph-full-spaghettify} and
\texttt{FSM\_GENERATION}\ref{paragraph-fsm-generation}
...
NB: Phase \texttt{FULL\_SPAGHETTIFY}\ref{paragraph-full-spaghettify}
...
A very basic and experimental C dumper. 
...
\subsection{Prettyprinters Smalltalk}
\label{subsection-prettyprinters-smalltalk}
\index{Prettyprinters Smalltalk}
\index{PHRASE}

This pass is used for PHRASE project.
...
\subsection{Prettyprinter for CLAIRE}
...
a C or Fortran program is dumped as CLAIRE objects, either DATA\_ARRAY or
TASK. CLAIRE is an object-oriented language used to develop constraint
solvers.
...
Limeil-BrÅÅÅÈvannes, by BenoÅÅÅÓt de Dinechin, Arnauld Leservot and Alexis
Platonoff.
...
\subsection{Prettyprinters for CM Fortran}
...
Computing, Ithaca (NY), August 1994
  ...
  \bibitem{B91} B. Baron,
{\em Construction flexible et cohÅÅÅÈrente pour la compilation interprocÅÅÅÈdurale},
...
{\em ÅÅÅ…tude et rÅÅÅÈalisation d'un compilateur pour le {\em High
Performance Fortran}},
Rapport interne EMP-CRI-A238, juin 1993

  \bibitem{CI95} BÅÅÅÈatrice Creusillet, FranÅÅÅÁois Irigoin, {\em
...
AoÅÅÅ˚t 1995 (also available as TR A/270).

\bibitem{CI96} BÅÅÅÈatrice Creusillet, FranÅÅÅÁois Irigoin, {\em Interprocedural
...
ThÅÅÅËse de doctorat de l'universitÅÅÅÈ Pierre et Marie Curie, juin 1987
...
{\em Compilation pour machines ÅÅÅ‡ mÅÅÅÈmoire rÅÅÅÈpartie},
Algorithmique ParallÅÅÅËle, Cosnard, Nivat, Robert Eds, Masson,
...
{\em Projet PIPS. Environnement de dÅÅÅÈveloppement},
...
\bibitem{Pla90} A. Platonoff, {\em Calcul des effets des procÅÅÅÈdures au
  moyen des rÅÅÅÈgions}, Rapport interne EMP-CAII-I132, juin 1990

\bibitem{Pla95a} A. Platonoff, {\em Contribution ÅÅÅ‡ la Distribution
  Automatique des DonnÅÅÅÈes pour Machines Massivement ParallÅÅÅËles},
  ThÅÅÅËse de doctorat de l'universitÅÅÅÈ Pierre et Marie Curie, 9 mars
  1995.
...
{\em Contribution ÅÅÅ‡ la parallÅÅÅÈlisation automatique de programmes
Fortran comportant des appels de procÅÅÅÈdure},
ThÅÅÅËse de docteur-ingÅÅÅÈnieur, UniversitÅÅÅÈ Pierre et Marie Curie,
dÅÅÅÈcembre 1984
...
Alto, June 23-27, 1986
  ...
  \bibitem{Y93} Y. Yang,
{\em Tests des dÅÅÅÈpendances et transformations de programme},
ThÅÅÅËse de doctorat de l'UniversitÅÅÅÈ Pierre et Marie Curie, 
15 Novembre 1993, rapport A/242.

  \bibitem{Z94} L. Zhou,
{\em Analyse
statique et dynamique de la complexitÅÅÅÈ des programmes 
scientifiques},
ThÅÅÅËse de doctorat de l'UniversitÅÅÅÈ Pierre et Marie Curie, 
