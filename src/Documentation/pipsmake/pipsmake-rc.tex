...
\newcommand{\PIPSMAKE}{\LINK{\emph{pipsmake/}}{http://www.cri.ensmp.fr/pips/pipsmake.html}}
...
\newcommand{\PViewTheHPFCompilerOutput}{{View the HPF
    Compiler Output}}
\newcommand{\Pri}{\LINK{\emph{Internal\space{}Representation}}{http://www.cri.ensmp.fr/pips/ri/ri.html}}
...
\newcommand{\EPIPS}{\LINK{\texttt{epips}}{http://www.cri.ensmp.fr/pips/wpips-epips-user-manual/wpips-epips-user-manual.html}}
\newcommand{\TPIPS}{\LINK{\texttt{tpips}}{http://www.cri.ensmp.fr/pips/line-interface.html}}
\newcommand{\WPIPS}{\LINK{\texttt{wpips}}{http://www.cri.ensmp.fr/pips/wpips-epips-user-manual/wpips-epips-user-manual.html}}
...
A prettyprint of the symbol table for one module can be generated,
either for C or Fortran modules.
\begin{verbatim}
...
structured and unstructured parts of code is explained elsewhere
...
\subsubsection{Considering a parallel code as a sequential one}
...
\subsubsection{Scalar and Array Expansion}
...
This pass generates XML code like the print\_xml\_code pass, but the input contains explicitly loops to scan motifs.
%%!UserManualDocumentation
