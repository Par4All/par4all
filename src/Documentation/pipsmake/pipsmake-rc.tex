...
ALIASING_ACROSS_FORMAL_PARAMETERS TRUE
\end{PipsProp}
...
"flow-sensitive" and "context-sensitive". Each value defines
 ...
 sensitivity are orthogonal]. The default value, "unique", implies
...
simd_remove_reductions      > MODULE.code
        ...
        < MODULE.dg
\end{PipsMake}
\begin{PipsProp}{SIMD_REMOVE_REDUCTIONS_ONLY_IN_LOOP}
SIMD_REMOVE_REDUCTIONS_ONLY_IN_LOOP TRUE
\end{PipsProp}
...
\begin{PipsMake}
recompile_module > MODULE.parsed_code
	< MODULE.code
\end{PipsMake}
