...
The compilation unit does not contain any function definitions after the\marginpar{gnih?}
...
containing C keywords and typedef names in each compilation
unit.\marginpar{mais de quoi ça cause ?}
...
\end{verbatim}
If you want to parse some C code, it is a good idea to select the C
parser with
\begin{alltt}
activate C_PARSER
\end{alltt}
for example in \texttt{tpips}.
