...
FILE* file;
{
    ...
    fprintf(file, "     $     INTFLAG,\n");
    fprintf(file, "     $     NBOFARRAYS,\n");
    fprintf(file, "     $     NBOFTEMPLATES,\n");
    fprintf(file, "     $     NBOFPROCESSORS,\n");
    fprintf(file, "     $     MAXSIZEOFPROCS\n\n");

    fprintf(file, "c\nc parameters\nc\n");

    fprintf(file, "      parameter(INTFLAG = -1234567890)\n");
    fprintf(file, "      parameter(NBOFARRAYS = %d)\n", gen_length(distributedarrays));
    fprintf(file, "      parameter(NBOFTEMPLATES = %d)\n", gen_length(templates));
    fprintf(file, "      parameter(NBOFPROCESSORS = %d)\n", gen_length(processors));
    fprintf(file, "      parameter(MAXSIZEOFPROCS = %d)\n", max_size_of_processors());
...
FILE* file;
{
    ...
    fprintf(file, "      include 'parameters.h'\n");
	 ...
	 MAPL(cd,
	  {
		  ...
		  break;
	      default:
		  pips_error("create_init_common_param", "unexpected style tag\n");
		  break;
	      }
