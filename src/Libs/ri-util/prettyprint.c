...
#ifndef lint
char lib_ri_util_prettyprint_c_rcsid[] = "$Header: /home/data/tmp/PIPS/pips_data/trunk/src/Libs/ri-util/RCS/prettyprint.c,v 1.173 2002/04/26 08:33:03 phamdat Exp $";
#endif /* lint */
