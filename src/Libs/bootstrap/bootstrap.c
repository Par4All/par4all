...
static IntrinsicDescriptor IntrinsicDescriptorTable[] = 
{
  ...
  {"getenv", 1, default_intrinsic_type, 0, 0},
  {"labs", 1, default_intrinsic_type, 0, 0},
  {"ldiv", 2, default_intrinsic_type, 0, 0},
  {"malloc", 1, default_intrinsic_type, 0, 0},
  {"mblen", 2, default_intrinsic_type, 0, 0},
  {"mbstowcs", 3, default_intrinsic_type, 0, 0},
  {"mbtowc", 3, default_intrinsic_type, 0, 0},
  {"qsort", 4, default_intrinsic_type, 0, 0},
  {"rand", 1, default_intrinsic_type, 0, 0},
  {"realloc", 2, default_intrinsic_type, 0, 0},
  {"srand", 1, default_intrinsic_type, 0, 0},
  {"strtod", 2, default_intrinsic_type, 0, 0},
  {"strtol", 3, default_intrinsic_type, 0, 0},
  {"strtoul", 3, default_intrinsic_type, 0, 0},
  {"system", 1, default_intrinsic_type, 0, 0},
  {"wctomb", 2, default_intrinsic_type, 0, 0},
  {"wcstombs", 3, default_intrinsic_type, 0, 0},
  {"exithandle", 1, default_intrinsic_type, 0, 0},
  {"drand48", 1, default_intrinsic_type, 0, 0},
  {"erand48", 1, default_intrinsic_type, 0, 0},
  {"jrand48", 1, default_intrinsic_type, 0, 0},
  {"lcong48", 1, default_intrinsic_type, 0, 0},
  {"lrand48", 1, default_intrinsic_type, 0, 0},
  {"mrand48", 1, default_intrinsic_type, 0, 0},
  {"nrand48", 1, default_intrinsic_type, 0, 0},
  {"seed48", 1, default_intrinsic_type, 0, 0},
  {"srand48", 1, default_intrinsic_type, 0, 0},
  {"putenv", 1, default_intrinsic_type, 0, 0},
  {"setkey", 1, default_intrinsic_type, 0, 0},
  {"swab", 3, default_intrinsic_type, 0, 0},
  {"mkstemp", 1, default_intrinsic_type, 0, 0},
  {"mkstemp64", 1, default_intrinsic_type, 0, 0},
  {"a64l", 1, default_intrinsic_type, 0, 0},
  {"ecvt", 4, default_intrinsic_type, 0, 0},
  {"fcvt", 4, default_intrinsic_type, 0, 0},
  {"gcvt", 3, default_intrinsic_type, 0, 0},
  {"getsubopt", 3, default_intrinsic_type, 0, 0},
  {"grantpt", 1, default_intrinsic_type, 0, 0},
  {"initstate", 3, default_intrinsic_type, 0, 0},
  {"l64a", 1, default_intrinsic_type, 0, 0},
  {"mktemp", 1, default_intrinsic_type, 0, 0},
  {"ptsname", 1, default_intrinsic_type, 0, 0},
  {"random", 1, default_intrinsic_type, 0, 0},
  {"realpath", 2, default_intrinsic_type, 0, 0},
  {"setstate", 1, default_intrinsic_type, 0, 0},
  {"srandom", 1, default_intrinsic_type, 0, 0},
  {"ttyslot", 1, default_intrinsic_type, 0, 0},
  {"unlockpt", 1, default_intrinsic_type, 0, 0},
  {"valloc", 1, default_intrinsic_type, 0, 0},
  {"dup2", 2, default_intrinsic_type, 0, 0},
  {"qecvt", 4, default_intrinsic_type, 0, 0},
  {"qfcvt", 4, default_intrinsic_type, 0, 0},
  {"qgcvt", 3, default_intrinsic_type, 0, 0},
  {"getcwd", 2, default_intrinsic_type, 0, 0},
  {"getexecname", 1, default_intrinsic_type, 0, 0},
  {"getlogin", 1, default_intrinsic_type, 0, 0},
  {"getopt", 3, default_intrinsic_type, 0, 0},
  {"getpass", 1, default_intrinsic_type, 0, 0},
  {"getpassphrase", 1, default_intrinsic_type, 0, 0},
  {"getpw", 2, default_intrinsic_type, 0, 0},
  {"isatty", 1, default_intrinsic_type, 0, 0},
  {"memalign", 2, default_intrinsic_type, 0, 0},
  {"ttyname", 1, default_intrinsic_type, 0, 0},
  {"atoll", 1, default_intrinsic_type, 0, 0},
  {"llabs", 1, default_intrinsic_type, 0, 0},
  {"lldiv", 2, default_intrinsic_type, 0, 0},
  {"lltostr", 2, default_intrinsic_type, 0, 0},
  {"strtoll", 3, default_intrinsic_type, 0, 0},
  {"strtoull", 3, default_intrinsic_type, 0, 0},
  {"ulltostr", 2, default_intrinsic_type, 0, 0},
