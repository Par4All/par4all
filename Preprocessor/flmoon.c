...
float *frac;
{
        ...
        *jd=2415020+28L*n+7L*nph;
        ...
        if (nph == 0 || nph == 2)
                xtra += (0.1734-3.93e-4*t)*sin((3.14159265/180.0)*as)-0.4068*sin((3.14159265/180.0)*am);
        else if (nph == 1 || nph == 3)
                xtra += (0.1721-4.0e-4*t)*sin((3.14159265/180.0)*as)-0.6280*sin((3.14159265/180.0)*am);
