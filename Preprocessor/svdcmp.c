...
int m,n;
{
        ...
        for (i=1;i<=n;i++) {
                ...
                anorm=(maxarg1=(anorm),maxarg2=((fabs(w[i])+fabs(rv1[i]))),(maxarg1) > (maxarg2) ? (maxarg1) : (maxarg2));
        }
        for (i=n;i>=1;i--) {
                if (i < n) {
                        if (g) {
        ...
        for (k=n;k>=1;k--) {
                for (its=1;its<=30;its++) {
                        ...
                        if (flag) {
                                ...
                                for (i=l;i<=k;i++) {
                                        ...
                                        if (fabs(f)+anorm != anorm) {
                                                g=w[i];
                                                h=((at=fabs(f)) > (bt=fabs(g)) ? (ct=bt/at,at*sqrt(1.0+ct*ct)) : (bt ? (ct=at/bt,bt*sqrt(1.0+ct*ct)): 0.0));
                                                w[i]=h;
                                                h=1.0/h;
                                                c=g*h;
                                                s=(-f*h);
                        ...
                        g=((at=fabs(f)) > (bt=fabs(1.0)) ? (ct=bt/at,at*sqrt(1.0+ct*ct)) : (bt ? (ct=at/bt,bt*sqrt(1.0+ct*ct)): 0.0));
                        ...
                        for (j=l;j<=nm;j++) {
                                ...
                                h=s*g;
                                g=c*g;
                                z=((at=fabs(f)) > (bt=fabs(h)) ? (ct=bt/at,at*sqrt(1.0+ct*ct)) : (bt ? (ct=at/bt,bt*sqrt(1.0+ct*ct)): 0.0));
                                rv1[j]=z;
                                c=f/z;
                                s=h/z;
                                f=x*c+g*s;
