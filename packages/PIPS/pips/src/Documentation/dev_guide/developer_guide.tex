...
Several validations run at CRI:
...
\item[AUTOC] compilation and validation with the \texttt{autoconf}
...
\item[PRIVE] compilation and validation on Ubuntu Karmic, including
  private/restricted stuff (hendaye).
\end{description}
