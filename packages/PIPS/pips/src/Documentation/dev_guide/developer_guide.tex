...
\begin{center}
\noindent
\includegraphics[scale=0.4]{eclipse/eclipse-project-creation-1}
\end{center}
\begin{center}
\noindent
\includegraphics[scale=0.35]{eclipse/eclipse-project-creation-2}
\end{center}
...
\begin{center}
\noindent
\includegraphics[scale=0.4]{eclipse/eclipse-missing-includes}
\end{center}
...
\begin{center}
\noindent
`\includegraphics[scale=0.4]{eclipse/eclipse-missing-includes-2}
\end{center}
...
\begin{center}
\noindent
\includegraphics[scale=0.35]{eclipse/eclipse-project-creation-add-includes}
\end{center}
...
\begin{center}
\noindent
\includegraphics[scale=0.4]{eclipse/eclipse-shortcut-vertical-bar}
\end{center}
...
\begin{center}
\noindent
\includegraphics[scale=0.4]{eclipse/eclipse-completion}
\end{center}
...
\begin{center}
\noindent
\includegraphics[scale=0.35]{eclipse/eclipse-symbol-lookup}
\end{center}
...
\item[pips\_validate]: \index{Validate} Non-regression tests;
  ...
  \item a corresponding \texttt{.tpips2} file which is executed as a
    tpips script, with the error stream is appended and possibly filtered
    by a \texttt{.flt} script afterwards.
    ...
    Please take care to filter only the significant part of the result,
    and that it should depend on pips only, so that it is likely to
...
\begin{verbatim}
  sh> cd validation
  sh> make -j 8 -l 10 new-validate
  sh> make -j 8 -l 10 TARGET='HardwareAccelerator Hpfc' new-validate
\end{verbatim}
