...
\newcommand{\PipsAutotoolsGuidePDF}{\LINK{http://www.cri.ensmp.fr/pips/developer_guide.htdoc/auto_pips.pdf}}
...
scripts must be \textbf{without any side effects} that may interact with
other scripts, for example that temporary files should be fully isolated
from those generated by other scripts.
%%
