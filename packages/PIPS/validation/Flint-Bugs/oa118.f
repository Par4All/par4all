...
C     April 1991
C      - stupid TIME() function added for Validation purpose, otherwise
C        the module cannot get through pipsmake without a user_error.
C     FC, 16/09/93
C
...
C
 ...
 174     CONTINUE
 173  CONTINUE
      WRITE(100,733)(JEX(N),N=1,NKJ)
      WRITE(100,733)(JIX(N),N=1,NKJ)
C
C
C     ******************************************************************
...
C
      ...
      WRITE(100,*) ' OAMET :',T
C
      READ(2,*) (IMD(I),I=1,NDOM)
      READ(2,*) (JMD(I),I=1,NDOM)
      IFA(1)=0
      DO 221 N=2,NDOM
...
C
      ...
      DO 999 I=1,NFAC
         WRITE(100,*)I
         WRITE(100,*)(AA(I,J),J=1,NFAC)
 999  CONTINUE
      
      WRITE(100,*)(O(I),I=1,NFAC)
C
      DO 250 I=1,NFAC
         PS(I)=O(I)
 250  CONTINUE
...
C
      READ(2,*) NBID,NBID
      READ(2,*)(ITR1(I),I=1,NTR1)
      READ(2,*)(ITR2(I),I=1,NTR2)
      PRINT 122,(ITR1(I),I=1,NTR1)
      PRINT 122,(ITR2(I),I=1,NTR2)
      DO 39 IJ=1,NFAC
      XF(IJ,0)=XF(IJ,4)
      YF(IJ,0)=YF(IJ,4)
      ZF(IJ,0)=ZF(IJ,4)
...
C     
       ...
       END
C
C TIME() function added only for Validation Purpose
C
