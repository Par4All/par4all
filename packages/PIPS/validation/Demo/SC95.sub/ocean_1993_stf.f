...
C
 9010 FORMAT (/,2X,42HSUBROUTINE    IN, EX-TIME FOR FIRST CALL =,1P,
     +       E13.6,8H SECONDS,/,2X,
     +       42HSUBROUTINE   OUT, EX-TIME FOR FIRST CALL =,1P,E13.6,/,
     +       2X,42HSUBROUTINE   RCS, EX-TIME FOR FIRST CALL =,1P,E13.6,
     +       /,2X,42HSUBROUTINE   CSR, EX-TIME FOR FIRST CALL =,1P,
     +       E13.6,/,2X,42HSUBROUTINE  SCSC, EX-TIME FOR FIRST CALL =,
     +       1P,E13.6,/,2X,42HSUBROUTINE  ACAC, EX-TIME FOR FIRST CALL =
     +       ,1P,E13.6,/,2X,
     +       42HSUBROUTINE FTRVMT EX-TIME FOR FIRST CALL =,1P,E13.6,/,
     +       2X,42HSUBROUTINE  SHUF, EX-TIME FOR FIRST CALL =,1P,E13.6,
     +       /,2X,42HSUBROUTINE UNSHUF EX-TIME FOR FIRST CALL =,1P,
     +       E13.6,/,2X,42HSUBROUTINE RPRINT EX-TIME FOR FIRST CALL =,
     +       1P,E13.6,/,2X,42HSUBROUTINE XLOG2, EX-TIME FOR FIRST CALL =
     +       ,1P,E13.6)
 9020 FORMAT (/,2X,42HSUBROUTINE   RCS, EX-TIME LAST TIMESTEP  =,1P,
     +       E13.6,8H SECONDS,/,2X,
     +       42HSUBROUTINE   CSR, EX-TIME LAST TIMESTEP  =,1P,E13.6,/,
     +       2X,42HSUBROUTINE  SCSC, EX-TIME LAST TIMESTEP  =,1P,E13.6,
     +       /,2X,42HSUBROUTINE  ACAC, EX-TIME LAST TIMESTEP  =,1P,
     +       E13.6,/,2X,42HSUBROUTINE FTRVMT EX-TIME LAST TIMESTEP  =,
     +       1P,E13.6)
 9030 FORMAT (/,2X,42HSUBROUTINE    IN, CUMULATIVE CALLS TO    =,I12,/,
     +       2X,42HSUBROUTINE   OUT, CUMULATIVE CALLS TO    =,I12,/,2X,
     +       42HSUBROUTINE   RCS, CUMULATIVE CALLS TO    =,I12,/,2X,
     +       42HSUBROUTINE   CSR, CUMULATIVE CALLS TO    =,I12,/,2X,
     +       42HSUBROUTINE  SCSC, CUMULATIVE CALLS TO    =,I12,/,2X,
     +       42HSUBROUTINE  ACAC, CUMULATIVE CALLS TO    =,I12,/,2X,
     +       42HSUBROUTINE FTRVMT CUMULATIVE CALLS TO    =,I12,/,2X,
     +       42HSUBROUTINE  SHUF, CUMULATIVE CALLS TO    =,I12,/,2X,
     +       42HSUBROUTINE UNSHUF CUMULATIVE CALLS TO    =,I12,/,2X,
     +       42HSUBROUTINE RPRINT CUMULATIVE CALLS TO    =,I12,/,2X,
     +       42HSUBROUTINE XLOG2, CUMULATIVE CALLS TO    =,I12)
 9040 FORMAT (/,2X,50HMEASURE OF WALL-CLOCK TIME (ENVIRONMENT SENSITIVE)
     +       ,/,2X,20HFOR EXECUTION ONLY =,1P,E13.6,1X,7HSECONDS)
C
...
C
      N1 = N1H + N1H
      JY1 = N2P/2 + 1
      WRITE (6,FMT=9040) (IX,NAME,JY1,RA(JY1,IX),IX=1,N1,4)
