...
C
 ...
 1235 PRINT *, "1235 IS A LABEL STATEMENT"

C     UNIT specifier : Integer or character expression
C     ================================================
      READ(UNIT=12345, FMT=10)
      READ(UNIT="STRING", FMT=10)
      READ(UNIT=I, FMT=10)
      READ(UNIT=CH, FMT=10)

      READ(UNIT=.TRUE., FMT=10)
      READ(UNIT=L, FMT=10)

C     Specifier must be a label statement
C     Like: ERR, END
C     ===================================
      READ(UNIT=12345, FMT=10, ERR=1234, END=1234)
...
C     Like: FMT, REC
C     ====================================================================
      READ(UNIT=12345, FMT=1235, REC=0)
