...
float x[],tolx,tolf;
{
        ...
        for (k=1;k<=ntrial;k++) {
                ...
                if (errf <= tolf) {free_matrix(alpha,1,n,1,n);free_vector(bet,1,n); free_ivector(indx,1,n);return;}
                ...
                if (errx <= tolx) {free_matrix(alpha,1,n,1,n);free_vector(bet,1,n); free_ivector(indx,1,n);return;}
        }
        {free_matrix(alpha,1,n,1,n);free_vector(bet,1,n); free_ivector(indx,1,n);return;}
}
