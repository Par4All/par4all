...
int iorder[],ncity;
{
        ...
        for (i=1;i<ncity;i++) {
                i1=iorder[i];
                i2=iorder[i+1];
                path += sqrt(((x[i2])-(x[i1]))*((x[i2])-(x[i1]))+((y[i2])-(y[i1]))*((y[i2])-(y[i1])));
        }
        i1=iorder[ncity];
        i2=iorder[1];
        path += sqrt(((x[i2])-(x[i1]))*((x[i2])-(x[i1]))+((y[i2])-(y[i1]))*((y[i2])-(y[i1])));
...
int iorder[],ncity,n[];
{
        ...
        de = -sqrt(((xx[3])-(xx[1]))*((xx[3])-(xx[1]))+((yy[3])-(yy[1]))*((yy[3])-(yy[1])));
        de -= sqrt(((xx[4])-(xx[2]))*((xx[4])-(xx[2]))+((yy[4])-(yy[2]))*((yy[4])-(yy[2])));
        de += sqrt(((xx[4])-(xx[1]))*((xx[4])-(xx[1]))+((yy[4])-(yy[1]))*((yy[4])-(yy[1])));
        de += sqrt(((xx[3])-(xx[2]))*((xx[3])-(xx[2]))+((yy[3])-(yy[2]))*((yy[3])-(yy[2])));
        return de;
}
...
int iorder[],ncity,n[];
{
        ...
        de = -sqrt(((xx[6])-(xx[2]))*((xx[6])-(xx[2]))+((yy[6])-(yy[2]))*((yy[6])-(yy[2])));
        de -= sqrt(((xx[5])-(xx[1]))*((xx[5])-(xx[1]))+((yy[5])-(yy[1]))*((yy[5])-(yy[1])));
        de -= sqrt(((xx[4])-(xx[3]))*((xx[4])-(xx[3]))+((yy[4])-(yy[3]))*((yy[4])-(yy[3])));
        de += sqrt(((xx[3])-(xx[1]))*((xx[3])-(xx[1]))+((yy[3])-(yy[1]))*((yy[3])-(yy[1])));
        de += sqrt(((xx[4])-(xx[2]))*((xx[4])-(xx[2]))+((yy[4])-(yy[2]))*((yy[4])-(yy[2])));
        de += sqrt(((xx[6])-(xx[5]))*((xx[6])-(xx[5]))+((yy[6])-(yy[5]))*((yy[6])-(yy[5])));
        return de;
}
