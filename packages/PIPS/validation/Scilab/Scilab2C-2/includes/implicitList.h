...
EXTERN_IMPLIST void dimplicitLists(float start, float step, float end, float *out);

EXTERN_IMPLIST void cimplicitLists(floatComplex start, floatComplex step, floatComplex end, float *out);

EXTERN_IMPLIST void zimplicitLists(floatComplex start, floatComplex step, floatComplex end, float *out);
