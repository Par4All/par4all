...
int main(int argc, char* argv[])
{
  ...
  double complex _tmp1 = cpow(_u_bs,4);
  scilab_rt_display_s0z0_("ans",_tmp1);
  double complex _tmp2 = cpow(5,_u_bs);
  ...
  scilab_rt_eltpow_z2i0_z2(1,2,_u_a,10,1,2,_tmp3);
  scilab_rt_display_s0z2_("ans",1,2,_tmp3);
  double complex _tmpxx3[1][2];
  scilab_rt_eltpow_z2i0_z2(1,2,_u_a,10,1,2,_tmpxx3);
  ...
  scilab_rt_eltpow_z0z2_z2(I,1,2,_u_a,1,2,_tmp5);
  ...
  scilab_rt_eltpow_i2z0_z2(3,3,_tmpxx5,I,3,3,_tmp6);
  ...
  scilab_rt_eltpow_z2i0_z2(1,2,_tmpxx8,2,1,2,_tmp7);
  ...
  _tmpxx9[2][2]=9;
  int _tmpxx10[3][3];
  scilab_rt_eltpow_i2i0_i2(3,3,_tmpxx9,1,3,3,_tmpxx10);
  double complex _tmpxx11 = (2*I);
  ...
  scilab_rt_eltpow_z2z2_z2(2,2,_tmpxx20,2,2,_tmpxx21,2,2,_tmp9);
  ...
  scilab_rt_eltpow_d3z0_z3(2,2,2,_u_b,_tmpxx25,2,2,2,_u_d);
  scilab_rt_display_s0z3_("d",2,2,2,_u_d);
  double complex _tmpxx26 = (3*I);
  double _tmpxx27[2][2][2];
  scilab_rt_eltpow_d3d3_d3(2,2,2,_u_b,2,2,2,_u_b,2,2,2,_tmpxx27);
  double complex _tmpxx28 = (1+_tmpxx26);
  double complex _u_f[2][2][2];
  scilab_rt_eltpow_d3z0_z3(2,2,2,_tmpxx27,_tmpxx28,2,2,2,_u_f);
