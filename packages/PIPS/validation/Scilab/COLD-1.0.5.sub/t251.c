...
int main(int argc, char* argv[])
{
  ...
  scilab_rt_sub_z2i0_z2(1,2,_u_a,10,1,2,_tmp0);
  scilab_rt_display_s0z2_("ans",1,2,_tmp0);
  double complex _tmpxx2[1][2];
  scilab_rt_sub_z2i0_z2(1,2,_u_a,10,1,2,_tmpxx2);
  ...
  scilab_rt_sub_z0z2_z2(I,1,2,_u_a,1,2,_tmp2);
  ...
  scilab_rt_sub_i2z0_z2(3,3,_tmpxx4,I,3,3,_tmp3);
  ...
  scilab_rt_sub_z2i0_z2(1,2,_tmpxx7,100,1,2,_tmp4);
  ...
  _tmpxx8[2][2]=9;
  int _tmpxx9[3][3];
  scilab_rt_sub_i2i0_i2(3,3,_tmpxx8,100,3,3,_tmpxx9);
  ...
  scilab_rt_sub_z2z2_z2(1,2,_tmpxx15,1,2,_tmpxx16,1,2,_tmp6);
  scilab_rt_display_s0z2_("ans",1,2,_tmp6);
  /*  3D */
  double _u_b[2][2][2];
  scilab_rt_ones_i0i0i0_d3(2,2,2,2,2,2,_u_b);
  double _tmpxx17[2][2][2];
  scilab_rt_sub_d3i0_d3(2,2,2,_u_b,1,2,2,2,_tmpxx17);
  ...
  scilab_rt_sub_z0d3_z3(_tmpxx20,2,2,2,_u_b,2,2,2,_tmpxx21);
  double complex _u_d[2][2][2];
  scilab_rt_sub_z3z0_z3(2,2,2,_tmpxx21,I,2,2,2,_u_d);
  scilab_rt_display_s0z3_("d",2,2,2,_u_d);
  double complex _tmp7[2][2][2];
  scilab_rt_sub_z3z3_z3(2,2,2,_u_c,2,2,2,_u_d,2,2,2,_tmp7);
