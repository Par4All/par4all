...
int main(int argc, char* argv[])
{
  ...
  /*  t255.sce: element wise division with complex */
  int _u_as = 2;
  scilab_rt_display_s0i0_("as",_u_as);
  double _tmp0 = ((double)_u_as/3);
  ...
  scilab_rt_eltdiv_z2i0_z2(1,2,_u_a,10,1,2,_tmp3);
  scilab_rt_display_s0z2_("ans",1,2,_tmp3);
  double complex _tmpxx3[1][2];
  scilab_rt_eltdiv_z2i0_z2(1,2,_u_a,10,1,2,_tmpxx3);
  ...
  scilab_rt_eltdiv_z0z2_z2(I,1,2,_u_a,1,2,_tmp5);
  ...
  scilab_rt_eltdiv_i2z0_z2(3,3,_tmpxx5,I,3,3,_tmp6);
  ...
  scilab_rt_eltdiv_z2i0_z2(1,2,_tmpxx8,100,1,2,_tmp7);
  ...
  _tmpxx9[2][2]=9;
  double _tmpxx10[3][3];
  scilab_rt_eltdiv_i2i0_d2(3,3,_tmpxx9,100,3,3,_tmpxx10);
  double complex _tmpxx11 = (200*I);
  double complex _tmp8[3][3];
  scilab_rt_add_d2z0_z2(3,3,_tmpxx10,_tmpxx11,3,3,_tmp8);
  ...
  scilab_rt_eltdiv_z2z2_z2(2,2,_tmpxx20,2,2,_tmpxx21,2,2,_tmp9);
  ...
  scilab_rt_eltdiv_d3z0_z3(2,2,2,_u_b,_tmpxx25,2,2,2,_tmpxx26);
  double complex _u_d[2][2][2];
  scilab_rt_eltdiv_z3z0_z3(2,2,2,_tmpxx26,I,2,2,2,_u_d);
  scilab_rt_display_s0z3_("d",2,2,2,_u_d);
  double complex _tmpxx27 = (4*I);
  double complex _tmpxx28 = (3+_tmpxx27);
  double complex _tmpxx29[2][2][2];
  scilab_rt_eltdiv_d3z0_z3(2,2,2,_u_b,_tmpxx28,2,2,2,_tmpxx29);
  double complex _u_e[2][2][2];
  scilab_rt_eltdiv_z3d0_z3(2,2,2,_tmpxx29,3.0,2,2,2,_u_e);
  scilab_rt_display_s0z3_("e",2,2,2,_u_e);
  double complex _tmpxx30 = (3*I);
  double _tmpxx31[2][2][2];
  scilab_rt_eltdiv_d3d3_d3(2,2,2,_u_b,2,2,2,_u_b,2,2,2,_tmpxx31);
  double complex _tmpxx32 = (1+_tmpxx30);
  double complex _u_f[2][2][2];
  scilab_rt_eltdiv_d3z0_z3(2,2,2,_tmpxx31,_tmpxx32,2,2,2,_u_f);
