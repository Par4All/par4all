 ...
 * for the output but it is negligible.
 *
 ...
 * by David Callahan, Jack Dongarra and David Levine except those whose number
 * is a 4-digit number.
 *
 */

// ignored by my version of gcc
...
/* To override the undefinition of the variable by PIPS*/
// #define __GNUC__ 4
...
// Function dummy is used to avoid dead code elimination by the compiler
...
int dummy(float a[LEN], float b[LEN], float c[LEN], float d[LEN], float e[LEN],
	  float a2[LEN2][LEN2], float b2[LEN2][LEN2], float c2[LEN2][LEN2],
	  float a0)
{
  float s = 0;
  for(int i; i<LEN;i++) {
...
// Version used by the authors: does not take time, but does not work
// if interprocedural analysis is turned on
#if 0
...
int init(char* name)
{
  ...
  if	(strcmp(name, "s000 ")==0) {
  ...
  }else if (strcmp(name, "s111 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
    set1d(c, any,frac2);
    set1d(d, any,frac2);
    set1d(e, any,frac2);
  } else if (strcmp(name, "s112 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s113 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s114 ")==0) {
    set2d(aa, any,frac);
    set2d(bb, any,frac2);
  } else if (strcmp(name, "s115 ")==0) {
    set1d(a, one,unit);
    set2d(aa,small,unit);
    set2d(bb,small,unit);
    set2d(cc,small,unit);
  } else if (strcmp(name, "s116 ")==0) {
    set1d(a, one,unit);
  } else if (strcmp(name, "s118 ")==0) {
    set1d(a, one,unit);
    set2d(bb,small,unit);
  } else if (strcmp(name, "s119 ")==0) {
    set2d(aa, one,unit);
    set2d(bb, any,frac2);
  } else if (strcmp(name, "s121 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s122 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s123 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s124 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s125 ")==0) {
    set1ds(LEN*LEN, array,zero,unit);
    set2d(aa, one,unit);
    set2d(bb,half,unit);
    set2d(cc, two,unit);
  } else if (strcmp(name, "s126 ")==0) {
    set2d(bb, one,unit);
    set1ds(LEN*LEN,array,any,frac);
    set2d(cc, any,frac);
  } else if (strcmp(name, "s127 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s128 ")==0) {
    set1d(a,zero,unit);
    set1d(b, two,unit);
    set1d(c, one,unit);
    set1d(d, one,unit);
  } else if (strcmp(name, "s131 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s132 ")==0) {
    set2d(aa, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s141 ")==0) {
    set1ds(LEN*LEN,array, one,unit);
    set2d(bb, any,frac2);
  } else if (strcmp(name, "s151 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s152 ")==0) {
    set1d(a, one,unit);
    set1d(b,zero,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s161 ")==0) {
    set1d(a, one,unit);
    ...
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s162 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s171 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s172 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s173 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s174 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s175 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s176 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s211 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s212 ")==0) {
    set1d(a, any,frac);
    set1d(b, one,unit);
    set1d(c, one,unit);
    set1d(d, any,frac);
  } else if (strcmp(name, "s221 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
    set1d(d, any,frac);
  } else if (strcmp(name, "s222 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
  } else if (strcmp(name, "s231 ")==0) {
    set2d(aa, one,unit);
    set2d(bb, any,frac2);
  } else if (strcmp(name, "s232 ")==0) {
    set2d(aa, one,unit);
    set2d(bb,zero,unit);
  } else if (strcmp(name, "s233 ")==0) {
    set2d(aa, any,frac);
    set2d(bb, any,frac);
    set2d(cc, any,frac);
  } else if (strcmp(name, "s234 ")==0) {
    set2d(aa, one,unit);
    set2d(bb, any,frac);
    set2d(cc, any,frac);
  } else if (strcmp(name, "s235 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
    set2d(aa, one,unit);
    set2d(bb, any, frac2);
  } else if (strcmp(name, "s241 ")==0) {
    set1d(a, one,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
    set1d(d, one,unit);
  } else if (strcmp(name, "s242 ")==0) {
    set1d(a,small,unit);
    set1d(b,small,unit);
    set1d(c,small,unit);
    set1d(d,small,unit);
  } else if (strcmp(name, "s243 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s244 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c,small,unit);
    set1d(d,small,unit);
  } else if (strcmp(name, "s251 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s252 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
  } else if (strcmp(name, "s253 ")==0) {
    set1d(a, one,unit);
    set1d(b,small,unit);
    set1d(c, one,unit);
    set1d(d, any,frac);
  } else if (strcmp(name, "s254 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
  } else if (strcmp(name, "s255 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
  } else if (strcmp(name, "s256 ")==0) {
    set1d(a, one,unit);
    set2d(aa, two,unit);
    set2d(bb, one,unit);
  } else if (strcmp(name, "s257 ")==0) {
    set1d(a, one,unit);
    set2d(aa, two,unit);
    set2d(bb, one,unit);
  } else if (strcmp(name, "s258 ")==0) {
    set1d(a, any,frac);
    set1d(b,zero,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e,zero,unit);
    set2d(aa, any,frac);
  } else if (strcmp(name, "s261 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
    set1d(c, any,frac2);
    set1d(d, one,unit);
  } else if (strcmp(name, "s271 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s272 ")==0) {
    set1d(a, one,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, two,unit);
  } else if (strcmp(name, "s273 ")==0) {
    set1d(a, one,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
    set1d(d,small,unit);
    set1d(e, any,frac);
  } else if (strcmp(name, "s274 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s275 ")==0) {
    set2d(aa, one,unit);
    set2d(bb,small,unit);
    set2d(cc,small,unit);
  } else if (strcmp(name, "s276 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
    set1d(d, any,frac);
  } else if (strcmp(name, "s277 ")==0) {
    set1d(a, one,unit);
    ...
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s2710")==0) {
    set1d(a, one,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s2711")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s2712")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s281 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
  } else if (strcmp(name, "s291 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
  } else if (strcmp(name, "s292 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
  } else if (strcmp(name, "s293 ")==0) {
    set1d(a, any,frac);
  } else if (strcmp(name, "s2101")==0) {
    set2d(aa, one,unit);
    set2d(bb, any,frac);
    set2d(cc, any,frac);
  } else if (strcmp(name, "s2102")==0) {
    set2d(aa,zero,unit);
  } else if (strcmp(name, "s2111")==0) {
    //		set2d(aa, one,unit);
    set2d(aa,zero,unit);
  } else if (strcmp(name, "s311 ")==0) {
    set1d(a, any,frac);
  } else if (strcmp(name, "s312 ")==0) {
    set1d(a,1.000001,unit);
  } else if (strcmp(name, "s313 ")==0) {
    set1d(a, any,frac);
    set1d(b, any,frac);
  } else if (strcmp(name, "s314 ")==0) {
    set1d(a, any,frac);
  } else if (strcmp(name, "s315 ")==0) {
    set1d(a, any,frac);
  } else if (strcmp(name, "s316 ")==0) {
    set1d(a, any,frac);
  } else if (strcmp(name, "s317 ")==0) {
  } else if (strcmp(name, "s318 ")==0) {
    set1d(a, any,frac);
    a[LEN-1] = -two;
  } else if (strcmp(name, "s319 ")==0) {
    set1d(a,zero,unit);
    set1d(b,zero,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s3110")==0) {
    set2d(aa, any,frac);
    aa[LEN2-1][LEN2-1] = two;
  } else if (strcmp(name, "s3111")==0) {
    set1d(a, any,frac);
  } else if (strcmp(name, "s3112")==0) {
    set1d(a, any,frac2);
    set1d(b,zero,unit);
  } else if (strcmp(name, "s3113")==0) {
    set1d(a, any,frac);
    a[LEN-1] = -two;
  } else if (strcmp(name, "s321 ")==0) {
    set1d(a, one,unit);
    set1d(b,zero,unit);
  } else if (strcmp(name, "s322 ")==0) {
    set1d(a, one,unit);
    set1d(b,zero,unit);
    set1d(c,zero,unit);
  } else if (strcmp(name, "s323 ")==0) {
    set1d(a, one,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s331 ")==0) {
    set1d(a, any,frac);
    a[LEN-1] = -one;
  } else if (strcmp(name, "s332 ")==0) {
    set1d(a, any,frac2);
    a[LEN-1] = two;
  } else if (strcmp(name, "s341 ")==0) {
    set1d(a,zero,unit);
    set1d(b, any,frac);
  } else if (strcmp(name, "s342 ")==0) {
    set1d(a, any,frac);
    set1d(b, any,frac);
  } else if (strcmp(name, "s343 ")==0) {
    set2d(aa, any,frac);
    set2d(bb, one,unit);
  } else if (strcmp(name, "s351 ")==0) {
    set1d(a, one,unit);
    set1d(b, one,unit);
    c[0] = 1.;
  } else if (strcmp(name, "s352 ")==0) {
    set1d(a, any,frac);
    set1d(b, any,frac);
  } else if (strcmp(name, "s353 ")==0) {
    set1d(a, one,unit);
    set1d(b, one,unit);
    c[0] = 1.;
  } else if (strcmp(name, "s411 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s412 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s413 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s414 ")==0) {
    set2d(aa, one,unit);
    set2d(bb, any,frac);
    set2d(cc, any,frac);
  } else if (strcmp(name, "s415 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
    a[LEN-1] = -one;
  } else if (strcmp(name, "s421 ")==0) {
    set1d(a, any,frac2);
  } else if (strcmp(name, "s422 ")==0) {
    set1d(array,one,unit);
    set1d(a, any,frac2);
  } else if (strcmp(name, "s423 ")==0) {
    set1d(array,zero,unit);
    set1d(a, any,frac2);
  } else if (strcmp(name, "s424 ")==0) {
    set1d(array,one,unit);
    set1d(a, any,frac2);
  } else if (strcmp(name, "s431 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s432 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s441 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  ...
  } else if (strcmp(name, "s442 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s443 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s451 ")==0) {
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s452 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c,small,unit);
  } else if (strcmp(name, "s453 ")==0) {
    set1d(a,zero,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "s471 ")==0) {
    set1d(a, one,unit);
    set1d(b, one,unit);
    set1d(c, one,unit);
    set1d(d, any,frac);
    set1d(e, any,frac);
  } else if (strcmp(name, "s481 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
    set1d(d, any,frac);
  } else if (strcmp(name, "s482 ")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "s491 ")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
  } else if (strcmp(name, "s4112")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
  } else if (strcmp(name, "s4113")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, any,frac2);
  } else if (strcmp(name, "s4114")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
  } else if (strcmp(name, "s4115")==0) {
    set1d(a, any,frac);
    set1d(b, any,frac);
  } else if (strcmp(name, "s4116")==0) {
    set1d(a, any,frac);
    set2d(aa, any,frac);
  } else if (strcmp(name, "s4117")==0) {
    set1d(a,zero,unit);
    set1d(b, one,unit);
    set1d(c, any,frac);
    set1d(d, any,frac);
  } else if (strcmp(name, "s4121")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
    ...
    set1d(a,zero,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "vag  ")==0) {
    set1d(a,zero,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "vas  ")==0) {
    set1d(a,zero,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "vif  ")==0) {
    set1d(a,zero,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "vpv  ")==0) {
    set1d(a,zero,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "vtv  ")==0) {
    set1d(a, one,unit);
    set1d(b, one,unit);
  } else if (strcmp(name, "vpvtv")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac);
    set1d(c, any,frac);
  } else if (strcmp(name, "vpvts")==0) {
    set1d(a, one,unit);
    set1d(b, any,frac2);
  } else if (strcmp(name, "vpvpv")==0) {
    set1d(a, any,frac2);
    set1d(b, one,unit);
    set1d(c,-one,unit);
  } else if (strcmp(name, "vtvtv")==0) {
    set1d(a, one,unit);
    set1d(b, two,unit);
    set1d(c,half,unit);
  } else if (strcmp(name, "vsumr")==0) {
    set1d(a, any,frac);
  } else if (strcmp(name, "vdotr")==0) {
    set1d(a, any,frac);
    set1d(b, any,frac);
  } else if (strcmp(name, "vbor ")==0) {
    set1d(a, any,frac);
    set1d(b, any,frac);
    set1d(c, one,frac);
    set1d(d, two,frac);
...
#if 0
void print_reg(__m128 rA){
  float ttt[4] __attribute__((aligned(16)));
  _mm_store_ps(ttt, rA);
  for (int i = 0; i < 4; i++)
    printf("%.5f ", (float)ttt[i]);
  printf("\n--------------\n");
...
#if 0
void trans(float mat[LEN2][LEN2], float res[LEN2][LEN2]){
  __m128 r1, r2, r3, r4;
  for (int i = 0; i < LEN2; i+=4){
    for (int j = 0; j < LEN2; j+=4){
      r1 = _mm_load_ps(&mat[i  ][j]);
      r2 = _mm_load_ps(&mat[i+1][j]);
      r3 = _mm_load_ps(&mat[i+2][j]);
      r4 = _mm_load_ps(&mat[i+3][j]);
      _MM_TRANSPOSE4_PS(r1, r2, r3, r4);
      _mm_store_ps(&res[j  ][i], r1);
      _mm_store_ps(&res[j+1][i], r2);
      _mm_store_ps(&res[j+2][i], r3);
      _mm_store_ps(&res[j+3][i], r4);
    }
  }
}
#endif
...
#if 0
void ppx (float* A, float* B, int N){
  __m128 rZ = _mm_setzero_ps();
  #define rPerm1 _MM_SHUFFLE(2,0,2,0)
  #define rPerm2 _MM_SHUFFLE(3,1,3,1)
  #define rSHR(reg) _mm_move_ss(_mm_shuffle_ps(reg,reg,_MM_SHUFFLE(2,1,0,0)),rZ)
  #define rSHR2(reg) _mm_shuffle_ps(rZ,reg,_MM_SHUFFLE(1,0,0,0))
  __m128 rA0,rA1,rA2,rA3,rA4,rA5,rA6,rA7,rA8,rA9,rA10,rA11,rA12,rA13,rA14,rA15;
  __m128 rAHelper, rSum;
  rSum = rZ;


  for(int k = 0; k<N; k+=32){
    rA0 = _mm_load_ps(&A[k]);
    rA1 = _mm_load_ps(&A[k+4]);
    rA2 = _mm_load_ps(&A[k+8]);
    rA3 = _mm_load_ps(&A[k+12]);
    rA4 = _mm_load_ps(&A[k+16]);
    rA5 = _mm_load_ps(&A[k+20]);
    rA6 = _mm_load_ps(&A[k+24]);
    rA7 = _mm_load_ps(&A[k+28]);

    rA8 = _mm_shuffle_ps(rA0,rA1,rPerm1);
    rA9 = _mm_shuffle_ps(rA0,rA1,rPerm2);
    rA10= _mm_shuffle_ps(rA2,rA3,rPerm1);
    rA11= _mm_shuffle_ps(rA2,rA3,rPerm2);
    rA12= _mm_shuffle_ps(rA4,rA5,rPerm1);
    rA13= _mm_shuffle_ps(rA4,rA5,rPerm2);
    rA14= _mm_shuffle_ps(rA6,rA7,rPerm1);
    rA15= _mm_shuffle_ps(rA6,rA7,rPerm2);

    rA0 = _mm_add_ps(rA9, rA8);
    rA1 = _mm_add_ps(rA11,rA10);
    rA2 = _mm_add_ps(rA13,rA12);
    rA3 = _mm_add_ps(rA15,rA14);

    rA4 = _mm_shuffle_ps(rA0,rA1,rPerm1);
    rA5 = _mm_shuffle_ps(rA0,rA1,rPerm2);
    rA6 = _mm_shuffle_ps(rA2,rA3,rPerm1);
    rA7 = _mm_shuffle_ps(rA2,rA3,rPerm2);

    rA0 = _mm_add_ps(rA5,rA4);
    rA1 = _mm_add_ps(rA7,rA6);

    rA2 = _mm_shuffle_ps(rA0,rA1,rPerm1);
    rA3 = _mm_shuffle_ps(rA0,rA1,rPerm2);

    rA0 = _mm_add_ps(rA3,rA2);

    rAHelper = rSHR(rA0);
    rA0 = _mm_add_ps(rA0,rAHelper);
    rAHelper = rSHR2(rA0);
    rA0 = _mm_add_ps(_mm_add_ps(rA0,rAHelper),rSum);

    rA1 = _mm_sub_ps(rA0,rA3);
    rA2 = _mm_unpacklo_ps(rA1,rA0);
    rA3 = _mm_unpackhi_ps(rA1,rA0);

    rA0 = _mm_sub_ps(rA2,rA5);
    rA1 = _mm_sub_ps(rA3,rA7);

    rA4 = _mm_unpacklo_ps(rA0,rA2);
    rA5 = _mm_unpackhi_ps(rA0,rA2);
    rA6 = _mm_unpacklo_ps(rA1,rA3);
    rA7 = _mm_unpackhi_ps(rA1,rA3);

    rA0 = _mm_sub_ps(rA4,rA9);
    rA1 = _mm_sub_ps(rA5,rA11);
    rA2 = _mm_sub_ps(rA6,rA13);
    rA3 = _mm_sub_ps(rA7,rA15);

    rA8 = _mm_unpacklo_ps(rA0,rA4);
    rA9 = _mm_unpackhi_ps(rA0,rA4);
    rA10= _mm_unpacklo_ps(rA1,rA5);
    rA11= _mm_unpackhi_ps(rA1,rA5);
    rA12= _mm_unpacklo_ps(rA2,rA6);
    rA13= _mm_unpackhi_ps(rA2,rA6);
    rA14= _mm_unpacklo_ps(rA3,rA7);
    rA15= _mm_unpackhi_ps(rA3,rA7);

    _mm_store_ps(&B[k   ], rA8);
    _mm_store_ps(&B[k+4 ], rA9);
    _mm_store_ps(&B[k+8 ], rA10);
    _mm_store_ps(&B[k+12], rA11);
    _mm_store_ps(&B[k+16], rA12);
    _mm_store_ps(&B[k+20], rA13);
    _mm_store_ps(&B[k+24], rA14);
    _mm_store_ps(&B[k+28], rA15);
    rSum = _mm_set1_ps(B[k+31]);
  }
//  print_array(A,64);
//  print_array(B,64);
#endif
...
#if 0
void ppx2 (float* A, float* B, int N){
  __m128 rZ = _mm_setzero_ps();
  #define rPerm1 _MM_SHUFFLE(2,0,2,0)
  #define rPerm2 _MM_SHUFFLE(3,1,3,1)
  #define rSHR(reg) _mm_move_ss(_mm_shuffle_ps(reg,reg,_MM_SHUFFLE(2,1,0,0)),rZ)
  #define rSHR2(reg) _mm_shuffle_ps(rZ,reg,_MM_SHUFFLE(1,0,0,0))
  __m128 rA0,rA1,rA2,rA3,rA4,rA5,rA6,rA7;
  __m128 rAHelper, rSum;
  rSum = rZ;
  ...
  for(int k = 0; k<N; k+=16){
    ...
    rA0 = _mm_add_ps(rA5, rA4);
    rA1 = _mm_add_ps(rA6, rA7);

    rA2 = _mm_shuffle_ps(rA0,rA1,rPerm1);
    rA3 = _mm_shuffle_ps(rA0,rA1,rPerm2);

    rA0 = _mm_add_ps(rA2,rA3);
    ...
    _mm_store_ps(&B[k   ], rA4);
    _mm_store_ps(&B[k+4 ], rA5);
    _mm_store_ps(&B[k+8 ], rA6);
    _mm_store_ps(&B[k+12], rA7);
    rSum = _mm_set1_ps(B[k+15]);
  }
//  print_array(A,64);
//  print_array(B,64);
}
...
int s1111()
{
  ...
  // float tempa[LEN] __attribute__((aligned(16)));
...
//	triangular saxpy loop
	...
	float TEMP[LEN2][LEN2] __attribute__ ((aligned(16)));
	clock_t start_t, end_t, clock_dif; double clock_dif_sec;
	...
	end_t = clock(); clock_dif = end_t - start_t;
	clock_dif_sec = (double) (clock_dif/1000000.0);
	printf("S1115_2\t %.2f \t\t", clock_dif_sec);;
	check(11);
	return 0;
}
#endif
...
int s1115_3()
{
  ...
  for (int nl = 0; nl < 100*(ntimes/LEN2); nl++) {
    __m128 rA, rB, rC1,rC2,rC3,rC4;
    for (int i = 0; i < LEN2; i+=4) {
      for (int j = 0; j < LEN2; j+=4) {
	rC1 = _mm_load_ps(&cc[j  ][i]);
	rC2 = _mm_load_ps(&cc[j+1][i]);
	rC3 = _mm_load_ps(&cc[j+2][i]);
	rC4 = _mm_load_ps(&cc[j+3][i]);
	_MM_TRANSPOSE4_PS(rC1,rC2,rC3,rC4);

	rA  = _mm_load_ps(&aa[i][j]);
	rB  = _mm_load_ps(&bb[i][j]);
	rA  = _mm_add_ps(_mm_mul_ps(rA,rC1),rB);
	_mm_store_ps(&aa[i][j],rA);

	rA  = _mm_load_ps(&aa[i+1][j]);
	rB  = _mm_load_ps(&bb[i+1][j]);
	rA  = _mm_add_ps(_mm_mul_ps(rA,rC2),rB);
	_mm_store_ps(&aa[i+1][j],rA);

	rA  = _mm_load_ps(&aa[i+2][j]);
	rB  = _mm_load_ps(&bb[i+2][j]);
	rA  = _mm_add_ps(_mm_mul_ps(rA,rC3),rB);
	_mm_store_ps(&aa[i+2][j],rA);

	rA  = _mm_load_ps(&aa[i+3][j]);
	rB  = _mm_load_ps(&bb[i+3][j]);
	rA  = _mm_add_ps(_mm_mul_ps(rA,rC4),rB);
	_mm_store_ps(&aa[i+3][j],rA);
      }
    }
    dummy(a, b, c, d, e, aa, bb, cc, 0.);
  }
  end_t = clock(); clock_dif = end_t - start_t;
  clock_dif_sec = (double) (clock_dif/1000000.0);
  printf("S1115_3\t %.2f \t\t", clock_dif_sec);;
  check(11);
  return 0;
}
#endif
...
int s3251()
{
  ...
  clock_t start_t, end_t, clock_dif; double clock_dif_sec;
  //	float temp_s[LEN+1] __attribute__ ((aligned(16)));
...
void s1421_2s(float* __restrict__ A, float* __restrict__ B, float* __restrict__ B2){
	for (int i = 0; i < LEN/2; i++){
		B[i] = B2[i] + A[i];
	}
}
...
//	equivalence- no overlap
	...
	for (int nl = 0; nl < 8*ntimes; nl++) {
		s1421_2s(a, b, &b[LEN/2]);
		dummy(a, b, c, d, e, aa, bb, cc, 1.);
	}
	end_t = clock(); clock_dif = end_t - start_t;
	clock_dif_sec = (double) (clock_dif/1000000.0);
	printf("S1421_2\t %.2f \t\t", clock_dif_sec);;
	temp = 0;
	for (int i = 0; i < LEN; i++){
		temp += xx[i];
	}
...
//	call statements
	...
	for (int nl = 0; nl < ntimes/2; nl++) {
		for (int i = 0; i < m; i++) {
			x[i] = b[i] + d[i] * d[i];
			// FI: I do not understand this call
			// s471s();
			b[i] = c[i] + d[i] * e[i];
		}
		dummy(a, b, c, d, e, aa, bb, cc, 0.);
